  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            src="https://res.cloudinary.com/da6w53p43/image/upload/v1691623004/64550a66c02517134f18105b_realtor-img5_anlron.jpg"
            height="100%"
            width="100%"
            alt="Listing"
            objectFit="cover"
        ...
        >
          <Box height="85%">
            <Image
              src="https://res.cloudinary.com/da6w53p43/image/upload/v1691623005/64550a6504618f4f221ea2dd_realtor-img4_j7ydq6.jpg"
